...
This contest builds upon work undertaken by BNSSG ICB, looking at ICS level performance indicators and predicting them into the future. The original teams tool can be found [here](https://sw-dsn.shinyapps.io/future-performance-tool/), and the project description [here](https://nhs-bnssg-analytics.github.io/fpt_analysis/outputs/01_index.html).
